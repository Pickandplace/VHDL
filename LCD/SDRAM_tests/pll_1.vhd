...
-- Module  Version: 5.7
--C:\lscc\diamond\3.9\ispfpga\bin\nt\scuba.exe -w -n pll_1 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 133 -fclkop 10 -fclkop_tol 5.0 -fclkos 130 -fclkos_tol 5.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -enable_ports -fb_mode 6 -lock 

-- Sat Aug 26 15:11:29 2017
...
architecture Structure of pll_1 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "10.431373";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  3, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  50, 
        ...
        CLKOS_DIV=>  4, CLKOP_DIV=>  51, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
