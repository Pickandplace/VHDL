...
-- Module  Version: 5.7
--C:\lscc\diamond\3.9\ispfpga\bin\nt\scuba.exe -w -n pll_1 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 133 -fclkop 10 -fclkop_tol 5.0 -fclkos 100 -fclkos_tol 5.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -enable_ports -fb_mode 6 -lock 

-- Wed Aug 23 19:38:26 2017
...
architecture Structure of pll_1 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "99.750000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "10.390625";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  4, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  47, 
        ...
        CLKOS_DIV=>  5, CLKOP_DIV=>  48, CLKFB_DIV=>  3, CLKI_DIV=>  4, 
