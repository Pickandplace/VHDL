...
-- Module  Version: 5.7
--C:\lscc\diamond\3.9\ispfpga\bin\nt\scuba.exe -w -n pll_1 -lang vhdl -synth lse -arch xo2c00 -type pll -fin 88.67 -fclkop 10 -fclkop_tol 5.0 -fclkos 100 -fclkos_tol 5.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -enable_ports -fb_mode 6 -lock 

-- Sat Aug 26 17:48:34 2017
...
architecture Structure of pll_1 is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "103.448333";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "10.344833";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "88.670000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  4, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  49, 
        ...
        CLKOP_ENABLE=> "DISABLED", CLKOS3_DIV=>  1, CLKOS2_DIV=>  1, 
        CLKOS_DIV=>  5, CLKOP_DIV=>  50, CLKFB_DIV=>  7, CLKI_DIV=>  6, 
        ...
        port map (CLKI=>CLKI, CLKFB=>CLKFB_t, PHASESEL1=>scuba_vlo, 
            ...
            ENCLKOS=>ENCLKOS, ENCLKOS2=>scuba_vlo, ENCLKOS3=>scuba_vlo, 
